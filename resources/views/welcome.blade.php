...
<body class="antialiased bg-gray-50">
    <!-- Navigation -->
    <nav x-data="{ mobileMenuOpen: false }" class="fixed w-full bg-white/95 backdrop-blur-md z-50 border-b border-gray-100 shadow-sm">
            ...
            <div class="flex justify-between h-20">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center space-x-3">
                        ...
                        {{-- <span class="text-2xl font-bold gradient-text">Sinistre Auto</span> --}}
                    </div>
                </div>
                ...
                <div class="hidden md:flex md:items-center md:space-x-8">
                    ...
                    <a href="#process" class="text-gray-700 hover:text-[#00008F] px-3 py-2 text-sm font-medium">FAQ</a>
                    @auth
                ...
                <div class="flex items-center md:hidden">
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="text-gray-700 hover:text-[#00008F]">
        ...
        <!-- Mobile menu -->
        <div x-show="mobileMenuOpen" class="md:hidden bg-white border-t border-gray-100" x-cloak>
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="#process" class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-[#00008F] hover:bg-gray-50 rounded-md">FAQ</a>
                @auth
